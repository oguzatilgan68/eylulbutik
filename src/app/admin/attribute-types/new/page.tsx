    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 p-6 sm:p-8 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm space-y-5">
        <div>
          ...
          <Input placeholder="Örn: Renk" value={name} onChange={(e) => setName(e.target.value)} required className="rounded-xl" />
        </div>
        ...
        <div>
          ...
          <div className="flex gap-2">
            <Input
              placeholder="Değer yazın (Örn: Kırmızı, S, M, L)"
              value={inputValue}
        ...
        <div className="flex justify-end pt-4 border-t border-gray-100 dark:border-gray-800">
          <Button type="submit" disabled={loading} className="bg-pink-600 hover:bg-pink-700 text-white rounded-xl px-6 font-medium shadow-md shadow-pink-500/20 cursor-pointer">
