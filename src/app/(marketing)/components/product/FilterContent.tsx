...
const FilterContent: React.FC<FilterContentProps> = ({
  ...
  return (
    <>
      ...
      <div className="fixed md:fixed bottom-0 right-0 md:top-0 md:right-0 md:h-full w-full md:w-96 bg-white dark:bg-gray-900 shadow-lg z-50 p-6 overflow-y-auto rounded-t-2xl md:rounded-none animate-slideUp md:animate-slideIn">
