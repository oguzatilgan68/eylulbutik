    ...
    <div className="mb-4 flex items-center gap-4">
      ...
      <div className="w-20 h-20 flex-shrink-0">
        {item.thumbnail ? (
          ...
          <div className="w-full h-full bg-gray-100 dark:bg-gray-700 rounded flex items-center justify-center text-gray-400">
            Resim Yok
          </div>
        )}
      </div>
        ...
        <div className="flex items-center gap-2 mt-1">
          ...
          <div className="flex items-center border border-gray-300 dark:border-gray-600 rounded overflow-hidden">
            <button
              type="button"
              onClick={decrement}
              disabled={!item.changeable || item.returnQty <= 0}
            ...
            <button
              type="button"
              onClick={increment}
              disabled={!item.changeable || item.returnQty >= item.qty}
              className="px-2 py-1 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 disabled:opacity-50"
            >
              +
            </button>
          ...
          <select
            ...
            className="border border-gray-300 dark:border-gray-600 p-1 w-[250px] rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 disabled:opacity-50"
          >
